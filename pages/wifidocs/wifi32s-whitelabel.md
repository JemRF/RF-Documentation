...
The WiFi Version 2 Sensor supports a private control panel. The hidden control panel provides customization of the sensor when viewed on the normal sensor contol panels. 

Option allow:
* Customizating the banner words and title at the top including forground and background colors.
